	...
	%>
		...
		<body>
			...
			<div class="centerContent">
					<h1>회원 정보 수정</h1>
					<form action="./updateMember" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
					...
					<!-- <input type="hidden" id="registtDate" name="registDate" value="${memberUpdateDetail.registDate}" > -->
					<table>
					...
					<div class="mb-3">
						...
						<input type="text" class="form-control" id="memId"  name="memId" value="${memberUpdateDetail.memId}" readonly>
					</div>
					<div class="mb-3">
					...
					<div class="mb-3">
						<label for="memPhone" class="form-label">핸드폰 번호</label>
						<input type="text" class="form-control phoneNumber" id="joinPwd" name="memPhone" value="${memberUpdateDetail.memPhone}" placeholder=" 하이픈(&quot;-&quot;)은 자동으로 입력됩니다.">
					</div>
					<div class="mb-3">
						<label for="memEmil" class="form-label">이메일</label>
						<input type="text" class="form-control" id="memEmil" name="memEmail" value="${memberUpdateDetail.memEmail}" >
					</div>
					<div class="mb-3">
					...
					<div class="mb-3">
						<label for="memEmil" class="form-label">비밀번호</label>
						<input type="password" class="form-control" id="joinPwdCheck" value="${memberUpdateDetail.memPwd}" >
						<span id="pswdDplChkresult"></span>
					</div>
					<div class="mb-3">
						<label for="memAuth" class="form-label">접근 권한</label>
						<input type="text" class="form-control" id="memAuth" name="memAuth" readonly="readonly" value="${memberUpdateDetail.memAuth}">
					</div>
					...
					<button type="button"  onclick="location.href='./memberList'">목록</button>
				</form>
