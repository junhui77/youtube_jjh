    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <body>
            ...
            <form action="./memberMyPageUpdate" id="updateFrm" name="updateFrm" method="post">
                    ...
                    <div style="float:right;padding-bottom:2px" class="boardBtn">
                ...
                <div class="mb-3">
                    <label for="boardTitle" class="form-label">프로필 이미지</label>
                        ...
                        <c:if test="${memberMyPageDetail.fileName == null}">
                            <div class="profileImgStyle"><img src="https://via.placeholder.com/300x300" alt="test이미지"></div>
                        </c:if>
                        <c:if test="${memberMyPageDetail.fileName != null}">
                            <!-- <div><img src="./resources/upload/230209/74c8bff5-d7eb-4fc0-8fea-3521d51a341btest3.png" alt="test이미지"></div> -->
                            <div class="profileImgStyle"><img src="./resources/upload/${memberMyPageDetail.filePath}/${memberMyPageDetail.fileUuid}${memberMyPageDetail.fileName}" alt="test이미지"></div>
                        </c:if>
