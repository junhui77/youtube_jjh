        ...
        <body>
            ...
            <div class="mb-3">
                <label for="boardTitle" class="form-label">프로필 이미지</label>
                    ...
                    <c:if test="${memberDetail.fileName == null}">
                    ...
                    <c:if test="${memberDetail.fileName != null}">
                        ...
                        <div class="profileImgStyle"><img src="./resources/upload/${memberDetail.filePath}/${memberDetail.fileUuid}${memberDetail.fileName}" alt="test이미지"></div>
                    </c:if>
