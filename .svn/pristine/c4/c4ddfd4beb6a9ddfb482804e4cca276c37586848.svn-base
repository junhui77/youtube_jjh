 	...
 	border: 1px solid #ccc;
  	...
  	font-size: 15px;
		...
		<div class="centerContent loginStyle" >
			...
			<h1>회원가입</h1>
			<form id="joinFrm" action="registerMember" method="POST" accept-charset="utf-8"  enctype="multipart/form-data"><!-- enctype="multipart/form-data" -->
				...
				<div class="profile-img">
					<div class="upload-display profileImgStyle">
						<span class="upload-thumb-wrap">
							<img src="https://via.placeholder.com/360x360" alt="기본이미지">
						</span>
					</div>
