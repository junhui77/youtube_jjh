    ...
    <body>
      ...
      <script>
       ...
       //   $('#follow').css({'background-color:':'#fff','color':'#fff','border':'1px solid #0d6efd'});
        ...
        getCommentNextList()
        // next 댓글 조회
        function getCommentNextList(page) {
        ...
        function getCommentList(data) {
          ...
          let htmlStr = "";
           ...
           for (let i = 0; i < replyList.length; i++) {
            ...
            console.log("replyList[i].filePath:",replyList[i].filePath)
            console.log("replyList[i].replyIdx:",replyList[i].replyIdx)
           ...
           htmlStr += "<div class=\"form-inline replyProfileImg mb-2\" ><img src=\"./resources/upload/" + replyList[i].filePath + "/" + replyList[i].fileUuid + replyList[i].fileName +"\" alt=\"test이미지\"></div>"
           //htmlStr += "<div class=\"form-inline mb-2\" > <img src=\"./resources/upload/${boardDetail.filePath}/${boardDetail.fileUuid}${boardDetail.fileName}\" alt=\"test이미지\"></div>"
            htmlStr += "<div class=\"form-inline replyProfileId  mb-2\" >" + replyList[i].memId + "</div>"
            htmlStr += "</div>"
...
function printReply(num) {
  ...
  if ($(".commentItem").length >= postsCnt) {
